...
/* Object interface: ISum, ver. 0.0,
   GUID={0x5821DADE,0x93E9,0x4CE5,{0x9D,0xC3,0xFB,0x64,0x2C,0x44,0xB8,0x1B}} */
...
/* Object interface: ISubtract, ver. 0.0,
   GUID={0xE3D36A29,0x5E61,0x4B01,{0x99,0x36,0x92,0x81,0x48,0x3B,0xD8,0x4D}} */
