...
{
	trace("ExeServer called");
	
	//trace("welcome to server");
...
HRESULT StartMyClassFactory(void)
{
	...
	hr = CoRegisterClassObject(CLSID_CTrigo,static_cast<IUnknown*>(gpIClassFactory), CLSCTX_LOCAL_SERVER, REGCLS_MULTIPLEUSE, &dwRegister);
