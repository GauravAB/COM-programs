...
const char *g_szFriendlyName = "DivideMultplyProviderComponent";
const char *g_szVerIndProgID = "ContainedInnerComponentWithoutRegfile";
const char *g_szProgID = "ContainedInnerComponentWithoutRegFile_1.0";
